const JOB_FEED_DATA = {
  ...
  opportunities: [
    {
      id: "kraft-heinz-2027-canada-internship",
      company: "Kraft Heinz",
      ...
      descriptionSignals: [
        {
          ...
          topics: ["learning/leadership", "learning/interview-stories"],
          why: "Interview answers should show ownership and growth",
        },
        {
          signal: "Simplifying complex concepts",
          topics: ["learning/communication", "learning/product-thinking"],
          why: "Strong fit for translating messy work into useful outcomes",
        },
        {
          signal: "Consumer insight and Gen Z examples",
          topics: ["learning/marketing", "learning/consumer-insight"],
          why: "Useful for business-case or behavioral prep",
        },
        {
          signal: "Supply-chain tracking example",
          topics: ["learning/supply-chain", "learning/operations"],
      ...
      timeline: [
        { date: "2026-08-14", label: "Applied", detail: "Submitted application" },
        { date: "2026-08-21", label: "Follow-up threshold", detail: "Seven-day review point" },
      ],
      decisionNotes: [
    ...
    {
      id: "kpmg-canada-technology-risk-services",
      company: "KPMG Canada",
      role: "Technology Risk Services Intern or Co-op",
      jobId: "33316",
      stage: "Applied",
      ...
      compensation: "$41,000 to $65,000 annualized base salary in Ontario",
      appliedAt: "2026-08-14",
      lastTouchAt: "2026-08-14",
      firstResponseAt: null,
      deadline: "2026-09-07",
